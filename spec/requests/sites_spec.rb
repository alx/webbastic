...
describe "resource(@site)" do 
  describe "a successful DELETE", :given => "a site exists" do
     before(:each) do
       @response = request(resource(Webbastic::Site.first), :method => "DELETE")
     end
...
describe "resource(@site, :edit)", :given => "a site exists" do
  before(:each) do
    @response = request(resource(Webbastic::Site.first, :edit))
  end
...
describe "resource(@site)", :given => "a site exists" do
  ...
  describe "GET" do
    before(:each) do
      @response = request(resource(Webbastic::Site.first))
    end
